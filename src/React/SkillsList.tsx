...
const SkillsList = () => {
  ...
  return (
    <div className="text-center pt-3">
      <h3 className="text-black text-3xl md:text-4xl font-semibold md:mb-6">
        What I do?
      </h3>
        ...
        {Object.entries(skills).map(([category, items]) => (
          <li key={category} className="w-full">
            <div
              ...
              className="md:w-[1100px] w-auto bg-[#1414149c] rounded-2xl text-left hover:bg-opacity-80 transition-all border border-[var(--white-icon-tr)] cursor-pointer overflow-hidden"
            >
